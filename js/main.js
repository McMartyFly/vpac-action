...
$(function() {
   ...
   ========================================================================== */
    ...
    $('#mc-form').ajaxChimp({
        language: 'cm',
        url: 'http://vetsinthefight.us13.list-manage.com/subscribe/post?u=fe3ecca56c18c69ae4bf3467e&id=1eb6f0a366'
    ...
    $('.counter').waypoint(function() {
        ...
        $('.total-number-3').animateNumber({
            number: 2, //change value here
            numberStep: comma_separator_number_step
        }, 2000);
        
        $('.total-number-4').animateNumber({
            number: 432, //change value here
            numberStep: comma_separator_number_step
        }, 2000);
